		   	...
		   	//主模式为MAIN_MODE1状态
		   	 {
				 switch(Sys.Mode.Sub_MAIN_MODE1)
					 ...
					 case MAINMODE1_SUBMODE1:
						 ...
						 {
							 //按0键,进入主界面1的子界面3
							 Sys.Mode.Sub_MAIN_MODE1=MAINMODE1_SUBMODE4;
						 }
						 if(Key.Value == KEY1_S)
						 {
							 //按1键,进入主界面1的子界面2
			  ...
			  //主模式为MAIN_MODE1状态
			   {
				   switch(Sys.Mode.Sub_MAIN_MODE2)
					   ...
					   case MAINMODE2_SUBMODE1:
						   ...
						   {
							   //按0键,进入主界面2的子界面3
							   Sys.Mode.Sub_MAIN_MODE2=MAINMODE2_SUBMODE4;
						   }
						   if(Key.Value == KEY1_S)
						   {
							   //按1键,进入主界面2的子界面2
				...
				//主模式为MAIN_MODE1状态
				 {
					 switch(Sys.Mode.Sub_MAIN_MODE3)
						 ...
						 case MAINMODE3_SUBMODE1:
							 ...
							 {
								 //按UP键,进入主界面1
								 Sys.Mode.Main_Mode=MAIN_MODE4;
								 Sys.Mode.Sub_MAIN_MODE1=MAINMODE4_SUBMODE1;
							 }
							 if(Key.Value == KEY0_S)
							 {
								 //按0键,进入主界面3的子界面3
								 Sys.Mode.Sub_MAIN_MODE3=MAINMODE3_SUBMODE4;
							 }
							 if(Key.Value == KEY1_S)
							 {
								 //按1键,进入主界面3的子界面2
				  ...
				  //主模式为MAIN_MODE1状态
				   {
					   switch(Sys.Mode.Sub_MAIN_MODE3)
						   ...
						   case MAINMODE4_SUBMODE1:
							   ...
							   {
								   //按0键,进入主界面3的子界面3
								   Sys.Mode.Sub_MAIN_MODE3=MAINMODE4_SUBMODE4;
							   }
							   if(Key.Value == KEY1_S)
							   {
								   //按1键,进入主界面3的子界面2
								   Sys.Mode.Sub_MAIN_MODE3=MAINMODE4_SUBMODE2;
							   }
						   break;
						   case MAINMODE4_SUBMODE2:
							   ...
							   {
								   //按0键,进入主界面3的子界面1
								   Sys.Mode.Sub_MAIN_MODE3=MAINMODE4_SUBMODE1;
							   }
							   if(Key.Value == KEY1_S)
							   {
								   //按1键,进入主界面3的子界面3
								   Sys.Mode.Sub_MAIN_MODE3=MAINMODE4_SUBMODE3;
							   }
