...
/**************************************************************************************************
  名称：Display_Proc
  功能: 根据系统状态更新显示缓冲区，Lcd_Trans
  参数说明：输入主要是系统状态Sys_Status全局变量
**************************************************************************************************/
//Date_Time_Struct DispDateTime;
void Disp_Proc(void)
{
		   	...
		   	//主模式为MAIN_MODE1状态
		   	 {
				 switch(Sys.Mode.Sub_MAIN_MODE1)
					 ...
					 case MAINMODE1_SUBMODE1:
						 ...
						 POINT_COLOR=BLACK;
						 LCD_ShowString(30,40,210,24,24,"MODE-1 ^_^"); 
						 LCD_ShowString(30,70,200,24,24,"SUBMODE1-1");
					 break;
					 case MAINMODE1_SUBMODE2:
							 //子模式为MAINMODE1_SUBMODE2状态
							 POINT_COLOR=BLACK;
							 LCD_ShowString(30,40,210,24,24,"MODE-1 ^_^"); 
							 LCD_ShowString(30,70,200,24,24,"SUBMODE1-2");
					 ...
					 case MAINMODE1_SUBMODE3:
						 ...
						 POINT_COLOR=BLACK;
						 LCD_ShowString(30,40,210,24,24,"MODE-1 ^_^"); 
						 LCD_ShowString(30,70,200,24,24,"SUBMODE1-3");
					 break; 
					 case MAINMODE1_SUBMODE4:
						 //子模式为MAINMODE1_SUBMODE3状态
						 POINT_COLOR=BLACK;
						 LCD_ShowString(30,40,210,24,24,"MODE-1 ^_^"); 
						 LCD_ShowString(30,70,200,24,24,"SUBMODE1-4");
					 break; 
					 default:
			  ...
			  //主模式为MAIN_MODE1状态
			   {
				   switch(Sys.Mode.Sub_MAIN_MODE2)
					   ...
					   case MAINMODE2_SUBMODE1:
						   ...
						   POINT_COLOR=BLACK;
						   LCD_ShowString(30,40,210,24,24,"MODE-2 ^_^"); 
						   LCD_ShowString(30,70,200,24,24,"SUBMODE2-1");
					   break;
					   case MAINMODE2_SUBMODE2:
							   //子模式为MAINMODE2_SUBMODE2状态
							   POINT_COLOR=BLACK;
							   LCD_ShowString(30,40,210,24,24,"MODE-2 ^_^"); 
							   LCD_ShowString(30,70,200,24,24,"SUBMODE2-2");
					   ...
					   case MAINMODE2_SUBMODE3:
						   ...
						   POINT_COLOR=BLACK;
						   LCD_ShowString(30,40,210,24,24,"MODE-2 ^_^"); 
						   LCD_ShowString(30,70,200,24,24,"SUBMODE2-3");
					   break; 
					   case MAINMODE2_SUBMODE4:
						   //子模式为MAINMODE2_SUBMODE3状态
						   POINT_COLOR=BLACK;
						   LCD_ShowString(30,40,210,24,24,"MODE-2 ^_^"); 
						   LCD_ShowString(30,70,200,24,24,"SUBMODE2-4");
					   break; 
					   default:
				...
				//主模式为MAIN_MODE1状态
				 {
					 switch(Sys.Mode.Sub_MAIN_MODE3)
						 ...
						 case MAINMODE3_SUBMODE1:
							 ...
							 POINT_COLOR=BLACK;
							 LCD_ShowString(30,40,210,24,24,"MODE-3 ^_^"); 
							 LCD_ShowString(30,70,200,24,24,"SUBMODE3-1");
						 break;
						 case MAINMODE3_SUBMODE2:
								 //子模式为MAINMODE3_SUBMODE2状态
								 POINT_COLOR=BLACK;
								 LCD_ShowString(30,40,210,24,24,"MODE-3 ^_^"); 
								 LCD_ShowString(30,70,200,24,24,"SUBMODE3-2");
						 break;
						 case MAINMODE3_SUBMODE3:
							 //子模式为MAINMODE3_SUBMODE3状态
							 POINT_COLOR=BLACK;
							 LCD_ShowString(30,40,210,24,24,"MODE-3 ^_^"); 
							 LCD_ShowString(30,70,200,24,24,"SUBMODE3-3");
						 break; 
						 case MAINMODE3_SUBMODE4:
							 //子模式为MAINMODE3_SUBMODE3状态
							 POINT_COLOR=BLACK;
							 LCD_ShowString(30,40,210,24,24,"MODE-3 ^_^"); 
							 LCD_ShowString(30,70,200,24,24,"SUBMODE3-4");
						 break; 
						 default:
				  ...
				  //主模式为MAIN_MODE1状态
				   {
					   switch(Sys.Mode.Sub_MAIN_MODE3)
						   {
						   case MAINMODE4_SUBMODE1:
							   //子模式为MAINMODE4_SUBMODE1状态
							   POINT_COLOR=BLACK;
							   LCD_ShowString(30,40,210,24,24,"MODE-4 ^_^"); 
							   LCD_ShowString(30,70,200,24,24,"SUBMODE4-1");
						   break;
						   case MAINMODE4_SUBMODE2:
								   //子模式为MAINMODE4_SUBMODE2状态
								   POINT_COLOR=BLACK;
								   LCD_ShowString(30,40,210,24,24,"MODE-4 ^_^"); 
								   LCD_ShowString(30,70,200,24,24,"SUBMODE4-2");
						   break;
						   case MAINMODE4_SUBMODE3:
							   //子模式为MAINMODE4_SUBMODE3状态
							   POINT_COLOR=BLACK;
							   LCD_ShowString(30,40,210,24,24,"MODE-4 ^_^"); 
							   LCD_ShowString(30,70,200,24,24,"SUBMODE4-3");
						   break; 
						   case MAINMODE4_SUBMODE4:
							   //子模式为MAINMODE4_SUBMODE3状态
							   POINT_COLOR=BLACK;
							   LCD_ShowString(30,40,210,24,24,"MODE-4 ^_^"); 
							   LCD_ShowString(30,70,200,24,24,"SUBMODE4-4");
						   break; 
						   default:
